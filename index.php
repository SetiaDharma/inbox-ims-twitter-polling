<?php
    ...
    while(true){
        ...
        while(!$done){
            $resources = $connection->get("application/rate_limit_status", ["resources" => "direct_messages"]);
            $direct_messages_resources = $resources->resources->direct_messages;
            
            foreach($direct_messages_resources as $key => $resource){
                if($key == "/direct_messages/events/list"){
            ...
            if(!$done){
                ...
                if(isset($direct_messages->events)){
